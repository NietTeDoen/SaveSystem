...
public class VariableHolder : MonoBehaviour, Isaveable
{
    public object SaveState()
    {
        return new SaveData()
        {
            //insert the Variables you want to save in a list like below.
    ...
    {
        //to load the data you gotta do it reveresed like shown below
    ...
    [Serializable] // it is also important to make this Serializable, otherwise you can't access it anywhere while you want to access it everywhere. you need to use {using.system;} for this.
    public struct SaveData
    {
        //these are all the variables that you want to save, these are important
